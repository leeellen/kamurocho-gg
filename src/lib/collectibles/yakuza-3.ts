...
export const yakuza3: CollectiblesData = {
  ...
  categories: [
    ...
    },
    {
      ...
      summary: {
        ko: "카무로쵸 지하 투기장의 모든 토너먼트에서 우승하면 「전설의 챔피언」 업적 발동. 클리어 후 모드의 「궁극 투기」를 전부 플레이하면 「궁극의 챌린저」도 함께 트리거됩니다.",
    ...
    },
    {
      ...
      summary: {
        ko: "카무로쵸 + 류큐 거리의 물품 보관함을 누적 10개 이상 열면 「열쇠의 방랑자」 업적 발동. 열쇠는 거리 곳곳에 흩어져 있습니다.",
    ...
    },
    {
      ...
      summary: {
        ko: "Yakuza 3 (극3 리마스터)의 서브스토리 31편 전부 정리했습니다. 오키나와 류큐 거리·아사가오 + 카무로쵸 양 도시에서 발생하며, 일부는 챕터 진행이 트리거입니다.",
      ...
      items: [
        { number: 1, title: { ko: "빨간 계열로 La La La", en: "Red Theme LaLaLa" }, location: { ko: "챕터 1, 카무로쵸", en: "Ch.1 Kamurocho" }, body: { ko: "휴대폰 커스터마이즈 + 모바일 액세서리", en: "Phone customization + accessories" } },
        ...
        { number: 18, title: { ko: "부탁해요 앗코 씨! 도쿄 편", en: "Please, Akko-san! Tokyo" }, location: { ko: "챕터 6, 카무로쵸", en: "Ch.6 Kamurocho" }, body: { ko: "츠빠리 클리어 후 동료 앗코 영입", en: "Recruits Akko after Tsuppari clear" } },
        { number: 19, title: { ko: "류구죠를 되찾아라", en: "Retake Ryugujo" }, location: { ko: "챕터 4, 카무로쵸", en: "Ch.4 Kamurocho" }, body: { ko: "도박 시설 해금", en: "Unlocks gambling facility" } },
        { number: 20, title: { ko: "정보화 사회에 오신 것을 환영합니다", en: "Welcome to the Info Society" }, location: { ko: "챕터 4, 카무로쵸", en: "Ch.4 Kamurocho" }, body: { ko: "정보 사회 스토리", en: "Information arc" } },
        { number: 21, title: { ko: "고민하는 신입사원", en: "The Troubled New Employee" }, location: { ko: "챕터 4, 카무로쵸", en: "Ch.4 Kamurocho" }, body: { ko: "기업 시나리오", en: "Corporate arc" } },
        { number: 22, title: { ko: "빨간 풍선", en: "Red Balloon" }, location: { ko: "챕터 9 낮, 카무로쵸", en: "Ch.9 day, Kamurocho" }, body: { ko: "어린이 공원 스토리", en: "Children's park arc" } },
        { number: 23, title: { ko: "그 아이의 행방", en: "Whereabouts of That Child" }, location: { ko: "챕터 4, 카무로쵸", en: "Ch.4 Kamurocho" }, body: { ko: "미아 미스터리 — 회복 아이템", en: "Missing-child mystery — recovery item" } },
        { number: 24, title: { ko: "주머니 속에는", en: "Inside the Pocket" }, location: { ko: "챕터 4, 카무로쵸", en: "Ch.4 Kamurocho" }, body: { ko: "극장가 시나리오", en: "Theater District arc" } },
        { number: 25, title: { ko: "화성 파이터 어게인", en: "Mars Fighter Again" }, location: { ko: "챕터 4, 카무로쵸", en: "Ch.4 Kamurocho" }, body: { ko: "액션 엔터테인먼트", en: "Action entertainment" } },
        { number: 26, title: { ko: "양아치와 라멘", en: "The Punk and Ramen" }, location: { ko: "챕터 4, 카무로쵸", en: "Ch.4 Kamurocho" }, body: { ko: "동료 마사히코 영입", en: "Recruits Masahiko" } },
        { number: 27, title: { ko: "한류 스타 코스프레", en: "Hallyu Star Cosplay" }, location: { ko: "챕터 4, 카무로쵸", en: "Ch.4 Kamurocho" }, body: { ko: "동료 토요미·키요미 영입", en: "Recruits Toyomi + Kiyomi" } },
        { number: 28, title: { ko: "그래도 인생은 계속된다", en: "Still, Life Goes On" }, location: { ko: "챕터 4, 카무로쵸", en: "Ch.4 Kamurocho" }, body: { ko: "점쟁이 동료 영입", en: "Recruits fortune teller" } },
        { number: 29, title: { ko: "사랑과 긍지", en: "Love and Pride" }, location: { ko: "챕터 6 밤, 카무로쵸", en: "Ch.6 night, Kamurocho" }, body: { ko: "호스트 클럽 동료 영입", en: "Recruits club host" } },
        { number: 30, title: { ko: "스타더스트 데뷔", en: "Stardust Debut" }, location: { ko: "챕터 6, 카무로쵸", en: "Ch.6 Kamurocho" }, body: { ko: "엔터테인먼트 동료 2명 영입", en: "Recruits 2 entertainment allies" } },
        { number: 31, title: { ko: "숙적과의 결전", en: "Showdown with the Rival" }, location: { ko: "챕터 12 엔딩 후, 카무로쵸", en: "Post-Ch.12, Kamurocho" }, body: { ko: "아레나 피날레 퀘스트", en: "Arena finale" } },
      ],
    },
    {
