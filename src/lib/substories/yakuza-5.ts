...
export const yakuza5Substories: SubstoriesData = {
  appId: 1105510,
  summary: {
    ko: "5인 주인공(키류/사에지마/하루카/아키야마/시나다) × 5개 도시(나가스가이=후쿠오카·츠키미노=삿포로·소텐보리=오사카·카무로쵸=도쿄·킨에이초=나고야) 합산 약 79건. 키류·사에지마·아키야마·시나다는 거리 ?아이콘 → 격투 기반. 하루카 편은 댄스/아이돌 미니게임 기반으로 전투가 없음. 챕터 진행에 따라 해금되며 본편 도중 놓치면 일부는 회수 불가.",
  ...
  groups: [
      ...
      items: [
        {
          ...
          body: { ko: "오키나와에서 카무로쵸로 가던 청년이 길을 잃고 곤란해한다. 키류가 사정을 듣고 도와준다.", en: "A young man from Okinawa is lost on his way to Kamurocho. Kiryu hears him out and helps." },
        ...
        },
        {
          ...
          protagonist: { ko: "키류", en: "Kiryu" },
          location: { ko: "카무로쵸 — 뉴 세레나", en: "Kamurocho — New Serena" },
        ...
        },
        {
          ...
          protagonist: { ko: "키류", en: "Kiryu" },
          location: { ko: "카무로쵸 — 킷사텐 알프스", en: "Kamurocho — Kissaten Alps" },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          protagonist: { ko: "사에지마", en: "Saejima" },
          location: { ko: "카무로쵸 — 소다 도장", en: "Kamurocho — Soda Dojo" },
          trigger: { ko: "챕터 1 이후 카무로쵸 소다 도장 방문", en: "Visit the Soda Dojo in Kamurocho after Chapter 1." },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          protagonist: { ko: "하루카", en: "Haruka" },
          location: { ko: "카무로쵸 — 센트럴 거리", en: "Kamurocho — Central St." },
        ...
        },
        {
          ...
          chapter: { ko: "3부 챕터 2~", en: "Part 3, Chapter 2+" },
          protagonist: { ko: "하루카", en: "Haruka" },
          location: { ko: "소텐보리 — 클럽 SEGA", en: "Sotenbori — Club SEGA" },
          trigger: { ko: "클럽 SEGA 앞 팬과 대화. 전투 없음", en: "Talk to the fan in front of Club SEGA. No combat." },
        ...
        },
        {
          ...
          chapter: { ko: "3부 챕터 2~", en: "Part 3, Chapter 2+" },
          protagonist: { ko: "하루카", en: "Haruka" },
          location: { ko: "소텐보리/카무로쵸", en: "Sotenbori / Kamurocho" },
    ...
    {
      title: { ko: "아키야마 편 — 오사카 소텐보리 + 카무로쵸", en: "Akiyama — Osaka (Sotenbori) + Kamurocho" },
      items: [
        {
          number: 49,
        ...
        },
        {
          ...
          chapter: { ko: "3부 챕터 4~", en: "Part 3, Chapter 4+" },
          protagonist: { ko: "아키야마", en: "Akiyama" },
          location: { ko: "소텐보리/카무로쵸 — 다이나 체어 외", en: "Sotenbori / Kamurocho — Dyna Chair area" },
        ...
        },
        {
          ...
          chapter: { ko: "최종부 최종 챕터", en: "Final Part, Final Chapter" },
          protagonist: { ko: "아키야마", en: "Akiyama" },
          location: { ko: "카무로쵸 — 나카도리 거리", en: "Kamurocho — Naka-do St." },
        ...
        },
        {
          ...
          protagonist: { ko: "아키야마", en: "Akiyama" },
          location: { ko: "카무로쵸 — 타이헤이 거리", en: "Kamurocho — Taihei St." },
