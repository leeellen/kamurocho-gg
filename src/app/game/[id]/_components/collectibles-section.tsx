...
const INTERACTIVE_CATEGORIES: Record<number, Record<string, "telephone" | "category">> = {
  ...
  3937550: { "coin-lockers": "category", "lalala-friends": "category", "photo-rally": "category", reapers: "category", "tuppari-scouts": "category", "love-boxes": "category" }, // Yakuza Kiwami 3
  ...
  2072450: { "photo-rally": "category" }, // Infinite Wealth
  1805480: { pets: "category" }, // Like a Dragon Ishin
};
