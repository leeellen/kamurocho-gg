...
export const lostJudgmentSubstories: SubstoriesData = {
  appId: 2058190,
  summary: {
    ko: "총 54건의 사이드 케이스 — 요코하마 이진초와 카무로쵸를 오가며 진행. No.43 이후는 「탐정 라이프 충실 팩」 DLC가 필수. 챕터 3에서 버즈 리서처(Buzz Researcher)가 해금되면 본격적으로 의뢰 보드(카무로쵸 야가미 탐정 사무소 / 이진초 요코하마 99과)에서 받을 수 있습니다. 사이드 케이스 클리어는 SP 보상과 청춘 능력치 상승으로 직결되므로 메인 스토리와 병행하는 것이 효율적입니다.",
  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          chapter: { ko: "챕터 4", en: "Chapter 4" },
          location: { ko: "카무로쵸 — 텐카이치 거리 제1빌딩 3층", en: "Kamurocho — Tenkaichi-dori Bldg 1, 3F" },
        ...
        },
        {
          ...
          location: { ko: "이진초 — Girl's Bite 앞", en: "Ijincho — outside Girl's Bite" },
    ...
    {
      title: { ko: "Girl's Bite 외전 (챕터 4 이후)", en: "Girl's Bite Side Stories (Chapter 4+)" },
      items: [
        {
          number: 35,
          title: { ko: "하루코의 이야기", en: "Haruko's Story" },
          chapter: { ko: "챕터 4 이후", en: "Chapter 4+" },
          location: { ko: "이진초 — Girl's Bite", en: "Ijincho — Girl's Bite" },
          trigger: { ko: "청춘 스토리 「걸즈 바 조사」 진행 중", en: "While progressing the Girls Bar School Story." },
          reward: { ko: "SP + Girl's Bite 친밀도", en: "SP + Girl's Bite affinity" },
        },
        {
          number: 36,
      ...
      items: [
        {
          ...
          location: { ko: "카무로쵸 — 야가미 탐정 사무소 앞", en: "Kamurocho — outside Yagami Detective Agency" },
    ...
    {
      title: { ko: "DLC — 탐정 라이프 충실 팩 (No.43~54)", en: "DLC — Detective's Essentials Pack (No.43–54)" },
      items: [
        {
          number: 43,
          title: { ko: "내가 인형 옷을 입는 이유", en: "Why I Wear the Mascot Suit" },
          chapter: { ko: "챕터 3", en: "Chapter 3" },
          location: { ko: "카무로쵸 — 아동 공원", en: "Kamurocho — Children's Park" },
        ...
        },
        {
          ...
          chapter: { ko: "챕터 4 이후", en: "Chapter 4+" },
          location: { ko: "카무로쵸 — 텐카이치 거리 입구", en: "Kamurocho — Tenkaichi-dori entrance" },
        ...
        },
        {
          ...
          chapter: { ko: "챕터 4 이후", en: "Chapter 4+" },
          location: { ko: "카무로쵸 — 야가미 탐정 사무소 의뢰", en: "Kamurocho — Yagami Detective Agency request" },
