  ...
  return (
    <div className="relative min-h-screen bg-[var(--bg-base)] text-[var(--text-primary)]">
      <div className="mx-auto flex max-w-[600px] flex-col items-center px-5 pb-24 pt-24 text-center md:pt-32">
        ...
        <h1 className="font-display m-0 mt-5 text-[36px] font-extrabold tracking-tight text-white md:text-[44px]">
          {isKo ? "일시적인 오류가 발생했어요" : "Something went wrong"}
        </h1>
        <p className="m-0 mt-3 max-w-[52ch] text-[16px] leading-7 text-[var(--text-secondary)]">
          {isKo
        ...
        {error.digest && (
          <p className="m-0 mt-2 font-mono text-[14px] text-[var(--text-tertiary)]">
