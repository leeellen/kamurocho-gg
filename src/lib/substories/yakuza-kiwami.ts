...
export const yakuzaKiwamiSubstories: SubstoriesData = {
  appId: 3717330,
  summary: {
    ko: "총 78건의 「트러블 미션」(서브 스토리)이 카무로쵸 전역에 분포. 마지막 보스 직전까지 모두 접근 가능하므로 시간 제한으로 놓칠 일은 없지만, 다이얼로그 선택을 잘못하면 보상·완료 카운트가 깨지는 항목이 있습니다. 챕터 4에서 약 35건이 한꺼번에 풀려 진행 순서를 잡기 어려우므로 메인 스토리와 병행해서 정리하는 편이 효율적입니다. 코마키 무술 시리즈(57~67)는 키류의 핵심 히트 액션을 제공하므로 최우선으로 진행 권장.",
  ...
  groups: [
    {
      title: { ko: "챕터 2~3 — 카무로쵸 복귀", en: "Chapter 2~3 — Return to Kamurocho" },
      items: [
        {
          number: 8,
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          chapter: { ko: "챕터 4", en: "Chapter 4" },
          location: { ko: "클럽 SEGA 나카미치점", en: "Club Sega — Nakamichi St." },
        ...
        },
        {
          ...
          body: { ko: "가출한 아들을 찾아달라는 부탁 — 카무로쵸 곳곳에서 단서를 찾아 격파.", en: "Hunt down their delinquent son across Kamurocho and put him in his place." },
          reward: { ko: "경험치", en: "EXP" },
        },
        {
          number: 25,
        ...
        },
        {
          ...
          chapter: { ko: "챕터 4", en: "Chapter 4" },
          location: { ko: "핑크 거리 (Beam 북쪽)", en: "Pink St. (north of Beam)" },
        ...
        },
        {
          ...
          chapter: { ko: "챕터 4", en: "Chapter 4" },
          location: { ko: "JeweL", en: "JeweL" },
          trigger: { ko: "JeweL 앞에서 호스티스의 부탁을 받기", en: "Hostess outside JeweL asks for help." },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          chapter: { ko: "챕터 5", en: "Chapter 5" },
          location: { ko: "디스코 Debolah", en: "Debolah dance club" },
        ...
        },
        {
          ...
          body: { ko: "카무로쵸에서 신권 2,000엔을 가진 사람을 찾아 입수. 콘비니 구매로도 가능.", en: "Track down (or buy at a Poppo) a 2,000-yen note and deliver it." },
    ...
    {
      title: { ko: "챕터 6~7 — 카무로쵸 격동", en: "Chapter 6~7 — Kamurocho Heats Up" },
      items: [
        {
          number: 5,
        ...
        },
        {
          ...
          location: { ko: "Bantam 바", en: "Bantam bar" },
          trigger: { ko: "Bantam에서 마스터의 부탁 듣기", en: "Hear the Bantam master out." },
        ...
        },
        {
          ...
          body: { ko: "여자친구에게 줄 선물을 카무로쵸에서 사오는 심부름.", en: "Source his girlfriend's gift from a Kamurocho shop." },
          reward: { ko: "경험치", en: "EXP" },
        },
        {
          number: 50,
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          chapter: { ko: "챕터 8", en: "Chapter 8" },
          location: { ko: "Stardust", en: "Stardust" },
          trigger: { ko: "Stardust 앞에서 호스티스의 이야기를 듣기", en: "Hear the hostess outside Stardust." },
        ...
        },
        {
          ...
          chapter: { ko: "챕터 8", en: "Chapter 8" },
          location: { ko: "클럽 SEGA", en: "Club Sega" },
        ...
        },
        {
          ...
          chapter: { ko: "챕터 8", en: "Chapter 8" },
          location: { ko: "클럽 SEGA 극장 광장점", en: "Club Sega — Theater Square" },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          trigger: { ko: "호텔가에서 카무로쵸 비공식 자경단 일행과 마주치기", en: "Meet the vigilante crew in the Hotel District." },
