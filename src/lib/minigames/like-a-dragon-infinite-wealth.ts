  ...
  minigames: [
    {
      ...
      howTo: [
        ...
        { ko: "만족도 효율 1위는 캬바레 클럽(만족도 9,121·인기도 50), 다음이 전통 일본식 건물(만족도 6,999·인기도 50)입니다. 자원이 모이면 이 두 건물부터 깔아 요구치를 단숨에 넘기세요. 반대로 신사는 효율이 나빠 만들지 않는 게 낫습니다.", en: "The most Satisfaction-efficient builds are the Cabaret Club (9,121 Satisfaction, 50 Popularity) and then the Traditional Japanese Building (6,999, 50) — lay these two first to blow past the requirements. The shrine, by contrast, is poor value; skip it." },
        { ko: "공간당 효율 끝판왕은 마지마 건설 헬멧(린넨 5+플라스틱 6, 개당 만족도 20·인기도 5, 1칸)입니다. 빈 땅에 도배하듯 깔면 만족도·인기도를 싸게 대량으로 채울 수 있습니다.", en: "The best Satisfaction-per-tile item is the Majima Construction Helmet (5 Linen + 6 Plastic, +20 Satisfaction / +5 Popularity each, 1 tile) — carpet empty land with them to bulk-fill both meters cheaply." },
        { ko: "인기도는 채집이 가장 효율적입니다. 같은 종을 일정 수 잡으면 +20점, 신규 종을 처음 잡으면 +80점이 들어옵니다. 농장섬과 연못을 연 뒤 대형 물고기를 노리세요. TV 광고는 하루 +200점이지만 회당 10만 제니라 자금 여유가 있을 때만 쓰세요.", en: "Collecting is the most efficient way to raise Popularity: +20 per quota of a species caught, +80 the first time you catch a new species. Open the farm island and pond, then target large fish. TV ads give +200/day but cost 100,000 zeni a pop — use only when flush." },
        { ko: "최종 클리어 기준은 만족도 약 43,000·인기도 약 13,000(총 12시간 안팎)입니다. 초반엔 크레이지 이츠로 16,000포인트를 모아 초밥집·버거집 설계도부터 사고, 목재·석재 가공소를 최대한 빨리 5개 깔아 자원 병목을 없애세요. 다이아·백금·금광석·진주는 절대 팔지 마세요.", en: "Final completion targets are roughly 43,000 Satisfaction and 13,000 Popularity (about 12 hours total). Early on, bank 16,000 points in Crazy Eats to buy the sushi and burger blueprints first, and lay all five lumber/stone processors ASAP to kill resource bottlenecks. Never sell diamond, platinum, or gold ore, or pearls." },
        { ko: "2성 달성 후 열리는 돈도코 팜에서 야쿠몬을 노동시키면 1시간마다 약 30만 제니 보너스가 들어옵니다. 광고·고급 가구 자금을 여기서 충당하세요. 관광객 이동 반경은 숙소 위치로 정해지니 활성(초록·빨강) 구역에만 숙소를 배치하세요.", en: "After reaching 2 stars, put Yakumon to work at Dondoko Farm for roughly 300,000 zeni per hour — bankroll ads and high-end furniture with it. Guest movement range is fixed by lodging placement, so build lodgings only in the active (green/red) zones." },
      ],
      videos: [
    ...
    },
    {
      ...
      howTo: [
        ...
        { ko: "배달 점수는 스시 > 피자 > 버거 순으로 큽니다. S랭크를 노린다면 스시 손님부터 먼저 처리하고(맵 최상단 도로가 스시 손님 밀집), 그 다음 피자, 버거 순으로 도세요.", en: "Deliveries score sushi > pizza > burger. For S-rank, clear sushi customers first (the topmost road is lined with sushi orders), then pizza, then burgers." },
        { ko: "골든 티켓은 배달 보너스를 1.5배로 올려 줍니다. 보일 때마다 약간 돌아가더라도 무조건 챙기세요. 점수 차이가 큽니다.", en: "The Golden Ticket boosts your delivery bonus by 1.5x — go out of your way for every one you see; it makes a big difference to the final tally." },
        { ko: "맵은 가로 3줄(북·중·남)·세로 3줄(서·중·동) 격자입니다. 남→서→북→동 순으로 외곽을 돌고 마지막에 중앙 줄을 처리하면 되돌아오는 동선이 줄어듭니다. 직선 도로에서 부스트를 터뜨려 음식을 쓸어 담으세요.", en: "The map is a grid of three horizontal roads (north/center/south) and three vertical (west/center/east). Loop the outer ring south to west to north to east, then finish the center row, to minimize backtracking — and pop your boost on the straights to vacuum up food." },
        { ko: "세 번 트릭을 채운 상태에서 측면 스틱+브레이크를 넣으면 파워 슬라이드가 나갑니다. 코너에서 속도를 거의 안 잃고 돌 수 있어 타임 어택에 유리합니다.", en: "With three tricks banked, hold the stick sideways and tap brake for a power slide — you round corners with almost no speed loss, which is huge for the time attack." },
      ],
      videos: [
    ...
    },
    {
      ...
      howTo: [
        ...
        { ko: "디스크릿 포는 도전 시점 레벨 가이드가 명확합니다. Jack ≈ Lv.9~10(진화체 2마리 이상 챙기면 유리), Queen ≈ Lv.18~20, Ace ≈ Lv.29~30, Joker ≈ Lv.38~40. 도전 전 본부·가챠에서 팀 레벨을 이 선까지 맞추고 가세요.", en: "The Discreet Four have clear level benchmarks: Jack ~Lv.9-10 (bring at least two evolved Sujimon), Queen ~Lv.18-20, Ace ~Lv.29-30, Joker ~Lv.38-40. Level your team to those lines at HQ/gacha before each challenge." },
        { ko: "추천 편성 예시 — Jack: Dance Dictator·Sodachi·Party Fouler·Squirmworm·Rebel Yeller·Jabber Jobber / Ace는 회복기가 없으니 순수 화력(Shadow Diver·Ganglord·Blood Shadow·Arminator·Gorgin' Gourmand·Freakalele)으로 밀어붙이세요. Joker·King전부터는 Freakalele 같은 회복 스킬 보유 스지몬을 반드시 1마리 넣으세요.", en: "Sample teams — Jack: Dance Dictator, Sodachi, Party Fouler, Squirmworm, Rebel Yeller, Jabber Jobber. Ace has no healing, so bring pure offense (Shadow Diver, Ganglord, Blood Shadow, Arminator, Gorgin' Gourmand, Freakalele). From Joker and King onward, always pack one healer like Freakalele." },
        { ko: "최종 보스 King(평균 Lv.48~50)은 팀이 다양 타입이라 만능 대응이 필요합니다. Extermination-kun·Forsaken Samurai·Strummagedon·King of Bling·Unquiet Rioter·Pandora's Boxer 같은 Lv.50 풀강 편성에 프로스트 한 마리를 더 끼우면 무게추가 기웁니다.", en: "Final boss King (avg ~Lv.48-50) fields a mixed-type team, so you need an all-rounder squad — a maxed Lv.50 lineup like Extermination-kun, Forsaken Samurai, Strummagedon, King of Bling, Unquiet Rioter, Pandora's Boxer, plus one extra Frost type to tip the scales." },
        { ko: "포획은 전투 승리 후 스지 기프트를 주는 타이밍 미니게임으로 진행됩니다. 미니게임 성공도와 기프트 등급이 높을수록 합류 확률이 오르니, 좋은 기프트를 아끼지 말고 쓰세요. 특정 타입을 노린다면 레이드(승리 시 항상 포획 기회)와 가챠를 적극 활용하세요.", en: "Recruiting is a timing minigame where you hand over a Suji Gift after winning — better minigame performance and higher-grade gifts raise the join chance, so don't hoard good gifts. To target a specific type, lean on Raids (a win always grants a recruit attempt) and the gacha." },
      ],
      videos: [
    ...
    },
    {
      ...
      howTo: [
        ...
        { ko: "줌인은 계속 유지하지 말고 대상이 보이는 순간만 잠깐 당겨 찍고 바로 줌아웃하세요. 계속 당겨 두면 시야가 좁아져 길가의 시코를 무더기로 놓칩니다.", en: "Don't hold the zoom — zoom in only for the split second you spot a target, snap, then zoom right back out; staying zoomed narrows your view and you'll miss whole clusters of sickos along the route." },
        { ko: "최종 점수는 기본 점수에 'Good' 사진 +50, 'Excellent' 사진 +150, 골든 보너스 +500이 합산됩니다. 중앙 정렬+줌으로 'Excellent' 판정을 노리고 골든은 반드시 챙겨야 S랭크가 안정적입니다.", en: "Final score adds +50 per 'Good' photo, +150 per 'Excellent', and +500 per Gold Bonus on top of base points — center and zoom for 'Excellent' grades and never skip the Gold for a reliable S-rank." },
        { ko: "시코 스냅을 플레이하면 카스가의 '친절(Kindness)' 성격 스탯이 오릅니다. 알로 해피 투어의 친절 요구 직업(예: 하우스키퍼)을 노린다면 겸사겸사 돌려 두면 좋습니다.", en: "Playing Sicko Snap raises Kasuga's Kindness personality stat — handy to grind alongside if you're working toward Alo-Happy Tours jobs that need Kindness (e.g. Housekeeper)." },
      ],
      videos: [
    ...
    },
    {
      ...
      howTo: [
        ...
        { ko: "투어→직업 대응과 요구치 예시: 다이빙 투어→아쿠아노트(친절 Lv.1, 무료/튜토리얼), 훌라 공연→지오댄서(열정 Lv.1, $200), 면세 쇼핑→하우스키퍼(친절 Lv.4, $200), 해변 요가→쿠노이치(지성 Lv.5, $1,600), 트롤리 투어→사무라이(자신감 Lv.5, $1,600). 요구 스탯을 미리 보고 부족한 성격치부터 채우세요.", en: "Tour-to-job map with requirements: Diving Tour → Aquanaut (Kindness Lv.1, free/tutorial), Hula Exhibition → Geodancer (Passion Lv.1, $200), Duty-Free Shopping → Housekeeper (Kindness Lv.4, $200), Yoga on the Shore → Kunoichi (Intellect Lv.5, $1,600), Trolley Tour → Samurai (Confidence Lv.5, $1,600). Check the required stat and top up whichever personality value is short first." },
        { ko: "참고로 Host·Breaker·Chef·Idol·Night Queen 직업은 챕터 8에 알로 해피 투어 접근과 함께 자동 해금되고, 이치반 전용 '스지맨서'는 알로 해피가 아니라 스지몬 스토리로 풀립니다. 투어로 굳이 안 풀어도 되는 직업을 헷갈리지 마세요.", en: "Note: the Host, Breaker, Chef, Idol, and Night Queen jobs auto-unlock in Chapter 8 when you gain Alo-Happy access, and Ichiban's exclusive Sujimancer comes from the Sujimon story, not the tours — don't waste effort tour-unlocking jobs you'll get anyway." },
      ],
      videos: [
