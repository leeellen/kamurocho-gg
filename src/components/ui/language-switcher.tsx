    ...
    <div className="inline-flex items-center gap-2">
      ...
      >
        <button
          ...
          lang="en"
          className={`inline-flex h-9 min-w-[44px] cursor-pointer items-center justify-center rounded-full px-3 text-[14px] font-bold uppercase tracking-wide transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-1 disabled:cursor-default ${
            locale === "en"
