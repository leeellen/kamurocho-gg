  ...
  return (
    <SiteShell locale={locale} section="home">
      <div className="mx-auto flex max-w-[640px] flex-col items-center px-5 pb-24 pt-24 text-center md:px-8 md:pt-32">
        ...
        <h1 className="font-display m-0 mt-3 text-[40px] font-extrabold leading-tight tracking-tight text-white md:text-[52px]">
          {isKo ? "찾으시는 페이지가 없어요" : "Page not found"}
        </h1>
        <p className="m-0 mt-4 max-w-[52ch] text-[16px] leading-7 text-[var(--text-secondary)]">
          {isKo
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Link
            href="/"
            className="inline-flex h-11 cursor-pointer items-center gap-2 rounded-full bg-[var(--accent)] px-5 text-[16px] font-bold text-white no-underline transition-colors hover:bg-[var(--accent-hover)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-base)]"
          >
