    ...
    <div className="inline-flex items-center gap-2">
      ...
      >
        <button
          ...
          lang="en"
          className={`min-w-[36px] cursor-pointer rounded-full px-2.5 py-1 text-[14px] font-bold uppercase tracking-wide transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-1 disabled:cursor-default ${
            locale === "en"
