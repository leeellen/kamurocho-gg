  ...
  groups: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          chapter: { ko: "챕터 4 (낮)", en: "Chapter 4 (daytime)" },
          location: { ko: "스낵 거리 — Survive 바 옆 공원", en: "Snack Alley — park next to Bar Survive" },
          trigger: { ko: "Sub#5·6 완료 후 낮 시간 Survive 바 옆 공원 방문", en: "Daytime visit after clearing Subs 5 and 6." },
          ...
          prereq: { ko: "Sub#5, Sub#6 완료", en: "Subs 5 & 6 cleared" },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          location: { ko: "이세자키 로드", en: "Isezaki Road" },
          trigger: { ko: "잡일(Part-time Hero) 알선 NPC에게 말 걸기", en: "Talk to the Part-Time Hero rep on Isezaki Road." },
        ...
        },
        {
          ...
          body: { ko: "회사 동료 사와 스미레의 사정. 깊은 결단을 내려 후반 미셔너블 라인의 출발점이 됩니다. Sub#52 트리거 조건의 일부.", en: "Sawa Sumire's personal arc — opens the late-game missable chain that culminates in Sub #52." },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          body: { ko: "곤경에 처한 모녀를 돕는 도입. Sub#23으로 연결.", en: "Help a mother-daughter pair in distress; sets up Sub #23." },
          reward: { ko: "진주 귀걸이", en: "Pearl Earrings" },
        },
        {
          number: 23,
          title: { ko: "각자의 마음", en: "Each One's Feelings" },
          chapter: { ko: "Sub#22 클리어 후", en: "After Sub #22" },
          location: { ko: "이세자키 로드 북부 → 센트럴 스트리트 → 병원", en: "North Isezaki Road → Central St → hospital" },
          trigger: { ko: "Sub#22 종료 후 같은 장소에서 메구미에게 접근", en: "After Sub #22, return to Megumi at the same spot." },
          ...
          prereq: { ko: "Sub#22 완료 + 소지금 100만엔", en: "Sub #22 cleared + 1,000,000 yen on hand" },
        ...
        },
        {
          ...
          reward: { ko: "J.A. (딜리버리 헬프)", en: "J.A. joins Delivery Help" },
        },
        {
          number: 27,
        ...
        },
        {
          ...
          body: { ko: "오노 미치오 위조 피규어 사건. Sub#30으로 연결.", en: "Counterfeit Ono Michio figurine caper; sets up Sub #30." },
          reward: { ko: "오노 미치오 피규어", en: "Ono Michio Figure" },
        },
        {
          number: 30,
          title: { ko: "용서받지 못한 자", en: "The Unforgiven" },
          chapter: { ko: "Sub#29 클리어 후", en: "After Sub #29" },
          location: { ko: "이진초", en: "Ijincho" },
          trigger: { ko: "Sub#29 종료 후 동일 지점 복귀", en: "Return to the same spot after Sub #29." },
          body: { ko: "위조 피규어 사건의 진범을 추적. 오노 미치오 본인이 딜리버리 헬프로 합류.", en: "Track down the forger; the real Ono Michio joins Delivery Help." },
          prereq: { ko: "Sub#29 완료", en: "Sub #29 cleared" },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          chapter: { ko: "Sub#37 클리어 후", en: "After Sub #37" },
          location: { ko: "이진초 — 서커스", en: "Ijincho — circus" },
          trigger: { ko: "Sub#37 클리어 후 서커스 복귀", en: "Return to circus after Sub #37." },
          body: { ko: "서커스 단원 추가 의뢰.", en: "Continuation of the circus storyline." },
          prereq: { ko: "Sub#37 완료", en: "Sub #37 cleared" },
          reward: { ko: "명예 메달", en: "Honor Medal" },
        },
        {
          number: 39,
          title: { ko: "애니멀 대서커스에 어서오세요 3", en: "Welcome to the Animal Circus 3" },
          chapter: { ko: "Sub#38 클리어 후", en: "After Sub #38" },
          location: { ko: "이진초 — 서커스", en: "Ijincho — circus" },
          trigger: { ko: "Sub#38 클리어 후 서커스 복귀", en: "Return to circus after Sub #38." },
          body: { ko: "서커스 라인 완결편. 클라라가 회사 직원으로 합류.", en: "Finale of the circus arc; Clara joins the company." },
          prereq: { ko: "Sub#38 완료", en: "Sub #38 cleared" },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          chapter: { ko: "Cerberus Cup 우승 후", en: "After winning Cerberus Cup" },
          location: { ko: "드래곤 카트장", en: "Dragon Kart course" },
          trigger: { ko: "Cerberus Cup 우승 후 카트장 복귀", en: "Return after the Cerberus Cup win." },
      ...
      items: [
        {
          ...
          location: { ko: "스낵 거리 — Survive 바 (낮)", en: "Snack Alley — Bar Survive (daytime)" },
          trigger: { ko: "낮 시간 Survive 바에서 사에코에게 「함께 한 잔」 선택", en: "Daytime: at Bar Survive choose 'Have a drink together' with Saeko." },
          body: { ko: "사에코와 둘만의 술자리. 선택지에 따라 인간력 스탯이 오릅니다. Sub#52 조건 중 하나.", en: "A solo drink with Saeko. Choices grant Personality-stat boosts and gate Sub #52." },
          choices: [
          ...
          reward: { ko: "아이템 없음 / 인간력 보너스 + Sub#52 진행 플래그", en: "No item reward; stat boosts and flag for Sub #52" },
        },
        {
          number: 48,
          title: { ko: "두 사람의 비전", en: "The Two's Vision" },
          chapter: { ko: "회사 랭킹 1위 + 다정함 Lv10 이후", en: "After company rank #1 + Kindness Lv10" },
          location: { ko: "스낵 거리 — Survive 바", en: "Snack Alley — Bar Survive" },
          trigger: { ko: "조건 달성 후 Survive 바 방문", en: "Visit Bar Survive after conditions met." },
          body: { ko: "이만이의 본드 마무리. Sub#52 조건.", en: "Eri-line bond capstone; gates Sub #52." },
          prereq: { ko: "회사 랭킹 1위 + 다정함 Lv10", en: "Company rank #1 + Kindness Lv10" },
          reward: { ko: "Sub#52 진행 플래그", en: "Flag for Sub #52" },
        },
        {
          number: 49,
        ...
        },
        {
          ...
          chapter: { ko: "Sub#14, 47~51 전부 완료 후", en: "After Sub #14 and Subs #47~51 all clear" },
          location: { ko: "스낵 거리 — Survive 바 2층", en: "Snack Alley — Bar Survive 2F" },
          trigger: { ko: "전 조건 충족 후 Survive 바 2층 방문", en: "Visit Bar Survive 2F after all prerequisites." },
          ...
          prereq: { ko: "Sub#14, Sub#47~51 전부 완료", en: "Sub #14 and Subs #47-51 all cleared" },
